...
<script>
    var mymap = L.map('mapid').setView([-7.8711071, 112.5247597], 17);
...
var m2 = L.marker([-7.8827648,112.5179046]).addTo(mymap);
    m2.bindPopup("<h1>Jatim Park 1</h1> <img src = '/img/jtp1.jpg' />")</script>
</html>
@endsection